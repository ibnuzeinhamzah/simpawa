defmodule Simpawa.SimpananPokokController do
  ...
  def index(conn, _params) do
    # anggota = Repo.all(Anggota) |> Enum.map(&{&1.name, &1.id})
    simpananpokok = Repo.preload(SimpananPokok, :anggota) # Repo.all(SimpananPokok)
  ...
  def new(conn, _params) do
    ...
    render(conn, "new.html", changeset: changeset, anggota: anggota)
  end
  ...
  def edit(conn, %{"id" => id}) do
    ...
    render(conn, "edit.html", simpanan_pokok: simpanan_pokok, changeset: changeset, anggota: anggota)
  end
